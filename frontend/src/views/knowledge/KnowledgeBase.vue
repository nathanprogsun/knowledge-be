...
const VIEW_MODE_KEY = 'kb.kb.docs.viewMode';
...
onMounted(() => {
  ...
  window.addEventListener('kb:knowledge-file-drop', handleKnowledgeFileDrop as EventListener);
  window.addEventListener('kb:open-knowledge', handleOpenKnowledgeEvent as EventListener);
});
...
onUnmounted(() => {
  ...
  window.removeEventListener('kb:knowledge-file-drop', handleKnowledgeFileDrop as EventListener);
  window.removeEventListener('kb:open-knowledge', handleOpenKnowledgeEvent as EventListener);
  stopMovePoll();
  if (timeout !== null) {
