...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 Knowledge Base？',
    answers: ['Knowledge Base 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['Knowledge Base 是什么？', '介绍一下 Knowledge Base'],
    negative_questions: ['这不是 Knowledge Base', '与 Knowledge Base 无关'],
    tag_name: '产品介绍',
  },
  {
