                ...
                <template v-for="group in navGroups" :key="group.key">
                  ...
                  <template v-for="item in group.items" :key="item.key">
                    <div :class="['nav-item', {
                      ...
                      <!-- Knowledge Base Cloud 使用自定义 W 图标 -->
                      <svg v-else-if="item.key === 'cloud'" width="17" height="17" viewBox="0 0 18 18"
            ...
            <div class="settings-content">
              <div class="content-wrapper" :class="{
                ...
                <template v-else>
                  ...
                  <div v-if="currentSection === 'cloud'" class="section">
                    <CloudSettings />
                  </div>
...
const navItems = computed(() => {
  ...
  const all: NavItem[] = [
    ...
    { key: 'cloud', icon: '', label: 'Knowledge Base Cloud' },
...
const navGroups = computed<NavGroup[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      items: pickItems(['models', 'ollama', 'cloud']),
    },
    {
      key: 'integrations',
