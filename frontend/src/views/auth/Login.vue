<template>
  <div class="login-layout">
    ...
    <div class="header-logo">
      <img src="@/assets/img/kb.svg" alt="Knowledge Base" class="logo-image" />
    </div>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a href="https://kb.weixin.qq.com" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a href="#" target="_blank" class="header-link" :title="$t('common.info')">
