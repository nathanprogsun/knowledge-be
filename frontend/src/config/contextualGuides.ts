...
export const GLOBAL_USER_GUIDE_KEY = 'kb:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'kb:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'kb:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'kb:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'kb:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'kb:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'kb:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'kb:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'kb:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'kb:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'kb:contextual-guide-agent-create:v1',
