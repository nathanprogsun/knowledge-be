export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and Knowledge Base parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    cloud: {
      ...
      description: 'Configure Knowledge Base Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Knowledge Base Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Knowledge Base Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Knowledge Base Cloud application secret',
      ...
      credentialConfigured: 'Cloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'Cloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'Cloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard Knowledge Base Cloud models for chat, retrieval, reranking, and vision.',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. kb/images',
      prefixPlaceholder: 'e.g. kb',
  ...
  createChat: {
    title: 'Hi, I am Knowledge Base — your knowledge, within reach',
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (kb-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (kb-ui)',
    ...
    parser: {
      ...
      engines: {
        ...
        cloud: {
          ...
          desc: 'Document parsing via Knowledge Base Cloud'
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and Cloud credentials.',
      ...
      signedFlowDetail: 'Keep the HMAC secret only on Knowledge Base and your trusted backend—never put it in requests or ship it to browsers. The request header carries the JWT string signed with that secret (it changes on each issuance or after expiry), not the secret itself. JWT must include sub (external user ID), tenant_id, aud=kb, and exp (max 24h lifetime).',
      ...
      hmacSecretDesc: 'Same secret stored in Knowledge Base; used only on your backend to sign JWTs—never send it as a request header.',
      ...
      signedRequestStep0: '# 0. Sign JWT on your backend (HS256, aud=kb, sub=user id, tenant_id={tenantId}, exp<=24h)',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted Knowledge Base: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On Knowledge Base Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      ...
      steps: {
        ...
        env: {
          ...
          desc: 'Set KB_BASE_URL and KB_API_KEY in your shell or ~/.zshrc / ~/.bashrc. The example below uses your current API base URL—replace the API Key with your actual value.'
        },
        install: {
      ...
      ecosystemNote: 'Skill hosted on ClawHub ({\'@\'}lyingbug/kb). See the ClawHub page for full API docs and version history.',
