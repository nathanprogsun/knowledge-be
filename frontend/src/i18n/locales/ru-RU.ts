export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      subtitle: 'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API Knowledge Base — загрузки, URL, Markdown и поиск.',
      ...
      ecosystemNote: 'Skill размещён на ClawHub ({\'@\'}lyingbug/kb). Полная документация API — на странице ClawHub.',
      installCta: 'Открыть ClawHub',
      installCtaHint: 'Установка Knowledge Base Skill · откроется в новой вкладке',
      hubMeta: 'ClawHub · {\'@\'}lyingbug/kb · MIT-0',
      steps: {
        verify: {
          title: 'Проверка',
        ...
        env: {
          ...
          desc: 'Задайте KB_BASE_URL и KB_API_KEY в shell или ~/.zshrc / ~/.bashrc. Пример ниже использует текущий API URL — замените API Key на фактическое значение.'
        },
        api: {
    ...
    chrome: {
      ...
      subtitle: 'Для self-hosted Knowledge Base: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В Knowledge Base Desktop задайте фиксированный порт API (например 37841) в API-информации.'
        },
        api: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Управление конфигурациями моделей, учётными данными, проверками подключения и данными Cloud.',
      ...
      hmacSecretDesc: 'Тот же secret, что в Knowledge Base; только для подписи JWT на backend — не отправляйте его в заголовке запроса.',
      ...
      signedRequestStep0: '# 0. Подпишите JWT на backend (HS256, aud=kb, sub=ID пользователя, tenant_id={tenantId}, exp не более 24 ч)',
  ...
  kbSettings: {
    parser: {
      ...
      engines: {
        ...
        cloud: {
          name: 'Knowledge Base Cloud',
          desc: 'Парсинг документов через Knowledge Base Cloud'
        },
        paddleocr_vl_cloud: {
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (kb-app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (kb-ui)',
  ...
  embedPublish: {
    ...
    webhookUrlPlaceholder: 'https://your-server.example.com/kb/embed-events',
    webhookUrlDesc: 'Optional. Knowledge Base POSTs message_sent / message_received events to this HTTPS endpoint.',
    webhookSecret: 'Webhook secret',
    webhookSecretPlaceholder: 'HMAC-SHA256 secret (X-Knowledge Base-Signature header)',
  ...
  createChat: {
    title: 'Привет, я Knowledge Base — ваши знания всегда под рукой',
  ...
  auth: {
    ...
    firstTime: 'Впервые в Knowledge Base?',
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с Knowledge Base',
  ...
  settings: {
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. kb/images',
      prefixPlaceholder: 'напр. kb',
    ...
    cloud: {
      title: 'Knowledge Base Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для Knowledge Base Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Knowledge Base Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Knowledge Base Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Knowledge Base Cloud',
      ...
      modelsSection: {
        ...
        descReady: 'Зарегистрируйте четыре стандартные модели Knowledge Base Cloud для чата, поиска, реранкинга и зрения.',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и Knowledge Base автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.'
      },
      welcome: {
        title: 'Добро пожаловать в Knowledge Base',
