...
AES-CBC decryption with PKCS#7 unpad, JSON coercion, credential
access, HTTP client construction, signature primitives,
...
def string_credential(credentials: JsonObject, key: str) -> str:
    ...
    """
    return credential_string(credentials, key)
