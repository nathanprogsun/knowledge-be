...
# ``tests/integration/core/knowledge/test_graph_builder_integration.py`` to
# keep this module free of integration-conftest imports (which set
# ``RBAC_ENFORCED=false`` at fixture-activation time and would otherwise
# leak into subsequent unit tests in the same pytest run).
